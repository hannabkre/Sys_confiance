...
public class TimeIntervalImpl extends MinimalEObjectImpl.Container implements TimeInterval {
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, petrinetPackage.TIME_INTERVAL__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		upperBoundESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, petrinetPackage.TIME_INTERVAL__UPPER_BOUND, oldUpperBound, upperBound, !oldUpperBoundESet));
	}
	...
	public void unsetUpperBound() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, petrinetPackage.TIME_INTERVAL__UPPER_BOUND, oldUpperBound, UPPER_BOUND_EDEFAULT, oldUpperBoundESet));
	}
