...
public interface petrinetFactory extends EFactory {
	 ...
	 * @generated
	 */
	petrinetFactory eINSTANCE = n7.petrinet.impl.petrinetFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Petrinet Element</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Petrinet Element</em>'.
	 * @generated
	 */
