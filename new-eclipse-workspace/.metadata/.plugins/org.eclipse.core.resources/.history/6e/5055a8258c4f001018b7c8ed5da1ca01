...
public class NodeImpl extends PetrinetElementImpl implements Node {
	...
	/**
	 * The cached value of the '{@link #getOutArc() <em>Out Arc</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOutArc()
	 * @generated
	...
	public EList<Arc> getInArc() {
		if (inArc == null) {
			inArc = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, petrinetPackage.NODE__IN_ARC, petrinetPackage.ARC__FROM_NODE);
		}
		return inArc;
	}
	...
	public EList<Arc> getOutArc() {
		if (outArc == null) {
			outArc = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, petrinetPackage.NODE__OUT_ARC, petrinetPackage.ARC__TO_NODE);
		}
		return outArc;
	}
