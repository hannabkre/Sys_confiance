 ...
 *   <li>{@link simplepdl.WorkDefinition#getUtilise <em>Utilise</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Utilise</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.UseRessource}.
	 * It is bidirectional and its opposite is '{@link simplepdl.UseRessource#getActivity <em>Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Utilise</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Utilise()
	 * @see simplepdl.UseRessource#getActivity
	 * @model opposite="activity" containment="true"
	 * @generated
	 */
	EList<UseRessource> getUtilise();
