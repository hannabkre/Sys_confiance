 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getUtilise <em>Utilise</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getUtilise() <em>Utilise</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getUtilise()
	 * @generated
	 * @ordered
	 */
	protected EList<UseRessource> utilise;
	 ...
	 */
	@Override
	public EList<UseRessource> getUtilise() {
		if (utilise == null) {
			utilise = new EObjectContainmentWithInverseEList<UseRessource>(UseRessource.class, this, SimplepdlPackage.WORK_DEFINITION__UTILISE, SimplepdlPackage.USE_RESSOURCE__ACTIVITY);
		}
		return utilise;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__UTILISE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getUtilise()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__UTILISE:
				return ((InternalEList<?>)getUtilise()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__UTILISE:
				getUtilise().clear();
				getUtilise().addAll((Collection<? extends UseRessource>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__UTILISE:
				return utilise != null && !utilise.isEmpty();
		}
