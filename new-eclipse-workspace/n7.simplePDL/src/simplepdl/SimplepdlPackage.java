...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Utilise</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__UTILISE = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int USE_RESSOURCE__RESSOURCE = 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getUtilise <em>Utilise</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Utilise</em>'.
	 * @see simplepdl.WorkDefinition#getUtilise()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_Utilise();
	...
	/**
	 * Returns the meta object for the container reference '{@link simplepdl.UseRessource#getActivity <em>Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Activity</em>'.
	 * @see simplepdl.UseRessource#getActivity()
	 * @see #getUseRessource()
	 * @generated
	 */
	EReference getUseRessource_Activity();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Utilise</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__UTILISE = eINSTANCE.getWorkDefinition_Utilise();
		 ...
		 * @generated
		 */
		EReference USE_RESSOURCE__ACTIVITY = eINSTANCE.getUseRessource_Activity();
