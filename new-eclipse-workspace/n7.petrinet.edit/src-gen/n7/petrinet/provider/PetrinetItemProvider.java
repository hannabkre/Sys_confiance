...
/**
 * This is the item provider adapter for a {@link n7.petrinet.petrinet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PetrinetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Petrinet_name_feature",
								"_UI_Petrinet_type"),
						petrinetPackage.Literals.Petrinet__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(petrinetPackage.Literals.Petrinet__Petrinet_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(petrinetPackage.Literals.Petrinet__Petrinet_ELEMENTS,
				PetrinetFactory.eINSTANCE.createPetrinetElement()));
