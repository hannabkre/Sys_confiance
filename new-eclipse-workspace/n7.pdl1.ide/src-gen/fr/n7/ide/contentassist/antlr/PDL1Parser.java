...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUseRessourceAccess().getGroup(), "rule__UseRessource__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getUseRessourcesAssignment_2_1_2(), "rule__WorkDefinition__UseRessourcesAssignment_2_1_2");
			...
			builder.put(grammarAccess.getUseRessourceAccess().getRessourceAssignment_1(), "rule__UseRessource__RessourceAssignment_1");
			builder.put(grammarAccess.getUseRessourceAccess().getQuantityAssignment_3(), "rule__UseRessource__QuantityAssignment_3");
