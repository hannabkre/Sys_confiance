...
// Entry rule entryRuleUseRessource
entryRuleUseRessource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getUseRessourceRule()); }
	iv_ruleUseRessource=ruleUseRessource
	{ $current=$iv_ruleUseRessource.current; }
	EOF;

// Rule UseRessource
ruleUseRessource returns [EObject current=null]
@init {
	enterRule();
}
@after {
