...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.USE_RESSOURCE:
				sequence_UseRessource(context, (UseRessource) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     UseRessource returns UseRessource
	 *
	 * Constraint:
	 *     (ressource=[Ressource|ID] quantity=INT)
	 * </pre>
	 */
	protected void sequence_UseRessource(ISerializationContext context, UseRessource semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.USE_RESSOURCE__RESSOURCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.USE_RESSOURCE__RESSOURCE));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.USE_RESSOURCE__QUANTITY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.USE_RESSOURCE__QUANTITY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getUseRessourceAccess().getRessourceRessourceIDTerminalRuleCall_1_0_1(), semanticObject.eGet(PDL1Package.Literals.USE_RESSOURCE__RESSOURCE, false));
		feeder.accept(grammarAccess.getUseRessourceAccess().getQuantityINTTerminalRuleCall_3_0(), semanticObject.getQuantity());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID useRessources+=UseRessource*)
	 * </pre>
	 */
