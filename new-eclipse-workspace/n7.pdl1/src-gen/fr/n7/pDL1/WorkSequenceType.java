...
public enum WorkSequenceType implements Enumerator
{
   ...
   * @ordered
   */
  START2START(0, "start2start", "startToStart"),
   ...
   * @ordered
   */
  FINISH2START(1, "finish2start", "finishToStart"),
   ...
   * @ordered
   */
  START2FINISH(2, "start2finish", "startToFinish"),
   ...
   * @ordered
   */
  FINISH2FINISH(3, "finish2finish", "finishToFinish");
   ...
   * <!-- end-user-doc -->
   * @see #START2START
   * @model name="start2start" literal="startToStart"
   * @generated
   * @ordered
   */
   ...
   * <!-- end-user-doc -->
   * @see #FINISH2START
   * @model name="finish2start" literal="finishToStart"
   * @generated
   * @ordered
   */
   ...
   * <!-- end-user-doc -->
   * @see #START2FINISH
   * @model name="start2finish" literal="startToFinish"
   * @generated
   * @ordered
   */
   ...
   * <!-- end-user-doc -->
   * @see #FINISH2FINISH
   * @model name="finish2finish" literal="finishToFinish"
   * @generated
   * @ordered
   */
