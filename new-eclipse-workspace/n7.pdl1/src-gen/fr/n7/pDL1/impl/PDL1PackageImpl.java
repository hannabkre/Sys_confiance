...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   */
  @Override
  public EReference getWorkDefinition_UseRessources()
  {
  ...
  {
    return (EReference)useRessourceEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EAttribute)useRessourceEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(workDefinitionEClass, WORK_DEFINITION__USE_RESSOURCES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getWorkDefinition_UseRessources(), this.getUseRessource(), null, "useRessources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getUseRessource_Ressource(), this.getRessource(), null, "ressource", null, 0, 1, UseRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getUseRessource_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, UseRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
