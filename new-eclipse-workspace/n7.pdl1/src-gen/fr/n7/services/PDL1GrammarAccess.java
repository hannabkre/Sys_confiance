...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class WorkDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cUseRessourcesKeyword_2_1_0 = (Keyword)cGroup_2_1.eContents().get(0);
		private final Keyword cColonKeyword_2_1_1 = (Keyword)cGroup_2_1.eContents().get(1);
		private final Assignment cUseRessourcesAssignment_2_1_2 = (Assignment)cGroup_2_1.eContents().get(2);
		private final RuleCall cUseRessourcesUseRessourceParserRuleCall_2_1_2_0 = (RuleCall)cUseRessourcesAssignment_2_1_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_2_2 = (Keyword)cGroup_2.eContents().get(2);
		
		//WorkDefinition:
		//    'wd' name=ID ( '{' ('useRessources' ':' useRessources+=UseRessource*)? '}' )?
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//'useRessources'
		public Keyword getUseRessourcesKeyword_2_1_0() { return cUseRessourcesKeyword_2_1_0; }
		
		//':'
		public Keyword getColonKeyword_2_1_1() { return cColonKeyword_2_1_1; }
		
		//useRessources+=UseRessource*
		public Assignment getUseRessourcesAssignment_2_1_2() { return cUseRessourcesAssignment_2_1_2; }
		
		//UseRessource
		public RuleCall getUseRessourcesUseRessourceParserRuleCall_2_1_2_0() { return cUseRessourcesUseRessourceParserRuleCall_2_1_2_0; }
	...
	public class UseRessourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.UseRessource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class WorkSequenceTypeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		...
		private final Keyword cStart2startStartToStartKeyword_0_0 = (Keyword)cStart2startEnumLiteralDeclaration_0.eContents().get(0);
		...
		private final Keyword cFinish2startFinishToStartKeyword_1_0 = (Keyword)cFinish2startEnumLiteralDeclaration_1.eContents().get(0);
		...
		private final Keyword cStart2finishStartToFinishKeyword_2_0 = (Keyword)cStart2finishEnumLiteralDeclaration_2.eContents().get(0);
		...
		private final Keyword cFinish2finishFinishToFinishKeyword_3_0 = (Keyword)cFinish2finishEnumLiteralDeclaration_3.eContents().get(0);
		...
		//'startToStart'
		public Keyword getStart2startStartToStartKeyword_0_0() { return cStart2startStartToStartKeyword_0_0; }
		
		//finish2start='finishToStart'
		public EnumLiteralDeclaration getFinish2startEnumLiteralDeclaration_1() { return cFinish2startEnumLiteralDeclaration_1; }
		
		//'finishToStart'
		public Keyword getFinish2startFinishToStartKeyword_1_0() { return cFinish2startFinishToStartKeyword_1_0; }
		
		//start2finish='startToFinish'
		public EnumLiteralDeclaration getStart2finishEnumLiteralDeclaration_2() { return cStart2finishEnumLiteralDeclaration_2; }
		
		//'startToFinish'
		public Keyword getStart2finishStartToFinishKeyword_2_0() { return cStart2finishStartToFinishKeyword_2_0; }
		
		//finish2finish='finishToFinish'
		public EnumLiteralDeclaration getFinish2finishEnumLiteralDeclaration_3() { return cFinish2finishEnumLiteralDeclaration_3; }
		
		//'finishToFinish'
		public Keyword getFinish2finishFinishToFinishKeyword_3_0() { return cFinish2finishFinishToFinishKeyword_3_0; }
	}
	...
	private final UseRessourceElements pUseRessource;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pUseRessource = new UseRessourceElements();
	...
	//    'q' quantity=INT
	//;
	public UseRessourceElements getUseRessourceAccess() {
		return pUseRessource;
	}
	
	public ParserRule getUseRessourceRule() {
		return getUseRessourceAccess().getRule();
	}
