...
import n7.petrinet.validation.Utils;
import n7.petrinet.validation.ValidationResult.ValidationError;
...
public class ValidationResult {
	/**
	 * Classe interne qui représente une erreur, avec l'objet source de l'erreur et
	 * le message associé.
	 */
	...
	/**
	 * Liste des erreurs enregistrées dans ce résultat (présumément mise à jour par
	 * un validateur)
	 */
	...
	/**
	 * Enregistre une erreur si et seulement si le test est échoué (le booléen est à
	 * faux). Cette méthode permet d'écrire les contraintes de manière un peu plus
	 * lisibles.
	 * 
	 * @param test   booléen qui détermine si l'erreur est à enregitrer ou non
	 * @param object objet en cours de visite qui est la source de l'erreur (le cas
	 *               échéant)
	 * @param error  message d'erreur
	 */
	...
	/**
	 * Récupère la liste des erreurs enregistrées dans le résultat et associées à
	 * une classe donnée.
	 * 
	...
	/**
	 * Récupère la liste des erreurs enregistrées dans le résultat et associées à
	 * une classe donnée, sous la forme d'un identifiant de classe (généralement
	 * défini dans le package associé au méta-modèle).
	 * 
