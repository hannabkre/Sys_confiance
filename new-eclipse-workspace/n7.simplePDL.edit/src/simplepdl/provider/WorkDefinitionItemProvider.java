...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplepdlPackage.Literals.WORK_DEFINITION__UTILISE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.WORK_DEFINITION__UTILISE,
				 SimplepdlFactory.eINSTANCE.createUseRessource()));
	}
